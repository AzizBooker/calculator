...
describe('operation',function(){
	xit(' returns the sum of two numbers',function(){
		expect(calculator.operation(calculator.sum,[10,10])).toEqual(20);
	});
	xit(' returns the sum of mutiple numbers',function(){
		expect(calculator.operation(calculator.sum,[10,10,20])).toEqual(40)
	});
	it(' returns the mutiplication of mutiple numbers',function(){
		expect(calculator.operation(calculator.multiply,[10,10,20])).toEqual(2000)
	});
	it(' returns the power of two numbers',function(){
		expect(calculator.operation(calculator.power,[10,2])).toEqual(100)
	});
